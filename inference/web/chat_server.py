...
INTRO_MESSAGE = (
    ...
    "और अगर आधार, PAN, राशन कार्ड, या किसी सरकारी योजना के बारे में पूछना हो "
    "तो वो भी बताऊँगी — कौन से documents लगते हैं, कहाँ जाना है, सब। "
    "तो बताइए, आपका नाम क्या है?"
)
